...
are present in the scene~\cite{Laffont14}. We consider 2
different networks and 3 different training methods.
...
One application is automatically labeling webcams in large webcam
collections, such as AMOS\cite{jacobs07amos}
...
\begin{compactitem}
  ...
  \item We compare several deep learning network architectures for
	...
	\item We achieve state of the art performance on the Transient Attributes
...
All of our netowrks were trained on NVIDIA M2075 GPU Cards for 24 hours
each, and evaluated using Caffe in CPU mode on Dell C6220 Servers 
equiped with Dual Intel E5-2670 8 Core (Sandy Bridge) @ 2.6 GHz.
The full network
