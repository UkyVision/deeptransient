...
\begin{figure}[t]
	\centering
		\includegraphics[width=0.5\textwidth, trim= 0mm 180mm 0mm 0mm]{figs/cartoon.pdf}
		\caption{\todo{replace me with a better cartoon!}}
		\label{fig:cartoon}
\end{figure}
...
\begin{figure*}
  ...
  \caption{This shows maps of the snow attribute from webcams across the
           ...
           ground truth data.\protect\footnotemark 
           The top row shows the ground truth snow maps and the bottom row 
...
\begin{figure}[t]
	\centering
		\includegraphics[width=0.5\textwidth, trim= 0mm 0mm 0mm 0mm]{figs/snow_exs.pdf}
		\caption{\todo{am I good? caption me please}}
		\label{fig:snow_exs}
\end{figure}
...
Canada was downloaded and labeled using TransientNet-H.  We split the region
into approximately one degree bins.  These maps show predicted snow coverage
using only transient attributes from webcam data.  Variation between the three
maps shows heavy snow coverage in the beginning of the month, snow melting in
the middle of the month, and a large snow storm in the north-east at the end of
the month.  Anomalous regions of high snow values, such as those along the
California coast, likely come from webcams facing a beach scene.  A beach with
light colored sand covering the ground appears visually similar to a snowy
scene.  Maps for other attributes show expected natural phenomena (the
...
the bin containing the webcam with the new attribute value.  
