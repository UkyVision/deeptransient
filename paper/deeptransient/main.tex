...
% these more in depth descriptions should go somewhere else
%
%Laffont~\cite{Laffont14} et al. was the first to propose the 40
...
%
%Lu et al.~\cite{lutwoclass} et al. classified images into one of two 
