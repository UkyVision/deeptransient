...
\begin{figure}[t]
	\centering
		\includegraphics[width=0.5\textwidth, trim= 0mm 0mm 0mm 0mm]{figs/snow_dt_vs_hays.pdf}
		\caption{This plot shows our predictions versus those of Laffont et al. 
             for the snow attribute over eleven months of webcam data.
             \todo{placeholder fig. should add example images to the plot}} 
		\label{fig:dtvshays_snow}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.49\textwidth}
    \centering
		\includegraphics[width=\textwidth, trim= 0mm 0mm 0mm 0mm]{figs/false_color_7371.pdf}
    \caption{false color image, RGB = [sunny, lush, snow]}
    \label{false_color_1}
  \end{subfigure}
  \begin{subfigure}[b]{0.49\textwidth}
    \centering
		\includegraphics[width=\textwidth, trim= 0mm 0mm 0mm 0mm]{figs/false_color_82.pdf}
    \caption{false color image, RGB = [sunny, storm, snow]}
    \label{false_color_2}
  \end{subfigure}
  \caption{false color image, red channel is sunny attribute, green channel
           is lush attribute, blue channel is snow attribute
           \todo{write actual captions for these figures}}
  \label{false_color_ims}
\end{figure}
...
\todo{talk about \figref{dtvshays_snow}}
