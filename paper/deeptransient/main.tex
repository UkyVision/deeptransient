...
layer\todo{dropout is after the first two fully-connected}) and three 
fully connected layers. The network parameters are selected by minimizing a
...
\begin{figure*}
  ...
  \caption{Maps of the snow attribute from webcams across the
           continental United States in January 2014 (\emph{bottom})
...
\begin{figure}
	\centering
		...
		\caption{Example of webcam geolocalization using
          ...
          Correlation maps with satellite imagery, where orange color
          means larger correlation. Ground-truth locations are marked
          by green dots, predictions by magenta squares.}
		\label{fig:geoloc}
\end{figure}
