...
\figref{ex_bad_transientnet} shows examples of images with an attribute that TransientNet-H
...
\todo{talk about \figref{ex_bad_cloudynet}}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.49\columnwidth}
	...
	\end{subfigure}	
	\caption{Two failure cases using CloudyNet and their incorrect classification.}
