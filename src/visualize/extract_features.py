...
dataset = 'transient'
base_dir = '/scratch/rmba229/'

if dataset == 'transient':
  out_dir  = '%s%s/features/' % (base_dir, dataset)
  im_db = '../training_data/train_shuffled_im_db/'
else:
...
base_dir = '/scratch/smwork3/learn/crossview/siamese_places/'
...
>>>>>>> 3395ecb220956be882b8df9b9e7986a3bb8dbf3d
